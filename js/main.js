...
btn.addEventListener("click", () => {
	if (active !== undefined) {
		...
		card.innerHTML = `<div class="loading">
      <span class="strip"></span>
		...
		setTimeout(() => {
			...
			card.innerHTML = `<svg width="162" height="108" xmlns="http://www.w3.org/2000/svg">
      <g fill="none">
         <path
   ...
   <span class="selected-count">You selected ${active} out of 5</span>
